...
- If Codex was **down (rate-limited) at PR-open**, that PR's initial content never got a Codex pass. For security-sensitive PRs, note "Codex did not run" and decide, once the limit recovers, whether to request one pass under the criteria above.
