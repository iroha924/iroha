...
Its front page is the **Overview**, and every number on it is one you can act on: how enforceable your approved guardrails actually are, which rules kept stopping the agent recently and where those denials clustered, and what is waiting for your review. Activity counts — sessions started, checkpoints written — are deliberately absent; a number nobody acts on only teaches you to skip the ones you should read.
