...
- [ ] If a security-sensitive package was touched (credential / subprocess / path handling), ran an adversarial review including `security-diff-reviewer` — evidence lands in the `iroha-review` summary comment posted on this PR
