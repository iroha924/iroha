...
/** Opens a fresh temp database with every `migrations/*.sql` file applied, ready for search tests. */
export async function openMigratedTestDb(prefix = "iroha-search-test-"): Promise<{
  dir: string;
  db: Database;
}> {
