...
const ja: Dict = {
  ...
  "runstatus.active": "実行中",
  "runstatus.completed": "完了",
  "runstatus.interrupted": "中断",
  "runstatus.abandoned": "放棄",
  "runstatus.failed": "失敗",
  "outcome.completed": "完了",
  "outcome.partial": "部分的",
  "outcome.blocked": "ブロック",
  "outcome.no_change": "変更なし",
  "vresult.passed": "成功",
  "vresult.failed": "失敗",
  "vresult.not_run": "未実行",
  "reftype.issue": "Issue",
  "reftype.pull_request": "プルリクエスト",
  "reftype.review": "レビュー",
  "reftype.commit": "コミット",
  "reftype.file": "ファイル",
  "reftype.symbol": "シンボル",
  "reftype.url": "URL",
  "reftype.document": "ドキュメント",
  ...
  "checkpoint.implementation": "実装",
  "checkpoint.validation": "検証",
  "checkpoint.unresolved": "未解決",
  "checkpoint.references": "参照",
  "search.title": "検索",
...
const en: Dict = {
  ...
  "vresult.passed": "Passed",
  "vresult.failed": "Failed",
  "vresult.not_run": "Not run",
  "reftype.issue": "Issue",
  "reftype.pull_request": "Pull request",
  "reftype.review": "Review",
